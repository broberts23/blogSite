...
![Azure resource group overview after Bicep deploy](./01-azure-resource-group-overview.png)
...
![Entra API app registration app roles](./02-entra-api-app-roles.png)
...
![Worker managed identity Graph permissions](./03-entra-worker-managed-identity-graph-permissions.png)
...
![Azure Web App Easy Auth configuration](./04-azure-api-app-service-easy-auth.png)
...
![Entra API app registration Expose an API scope](./05-entra-api-expose-oauth-scope.png)
...
![Entra Enterprise application user role assignment](./06-entra-enterprise-app-user-role-assignment.png)
...
![Decoded JWT bearer token showing roles claim](./07-decoded-jwt-bearer-token-roles.png)
...
![API request POST returning 202 Accepted](./08-api-request-post-accepted-202.png)
...
![Webhook callback receipt for completed provisioning](./09-webhook-callback-hr-spa-completed.png)
...
![Vended HR SPA authentication redirect URI](./10-entra-vended-hr-spa-authentication-redirect.png)
...
![Vended HR SPA application roles](./11-entra-vended-hr-app-roles.png)
...
![Report-only Conditional Access policy for HR portal](./12-entra-conditional-access-hr-compliant-device-report-only.png)
...
![AKS federated credential on vended application](./13-entra-vended-aks-federated-identity-credential.png)
...
![Webhook callback receipt for AKS workload](./14-webhook-callback-aks-workload-completed.png)
...
![Payroll application optional claim xms\_cc](./15-entra-vended-payroll-token-optional-claim-xms-cc.png)
...
![Privileged payroll Conditional Access session controls](./16-entra-conditional-access-payroll-one-hour-session.png)
...
If you're interested in the Application Registration Vending Machine, you can find the code on my [GitHub Repo](https://github.com/broberts23/vsCode/tree/main/project-app-vending-machine).

If you're interested in learning more about Idenity Security, you can check out my other blog posts on the topic:

* [Enhance Workload Identity Security with Just-In-Time RBAC in GitHub Actions and PowerShell](http://benroberts.io/enhance-workload-identity-security-with-just-in-time-rbac-in-github-actions-and-powershell)
* [Enhance Entra Identity Governance with Azure Event Grid](http://benroberts.io/enhance-entra-identity-governance-with-azure-event-grid)
* [Building an Expanded Identity Security Copilot with Azure AI Foundry](http://benroberts.io/building-an-expanded-identity-security-copilot-with-azure-ai-foundry)
