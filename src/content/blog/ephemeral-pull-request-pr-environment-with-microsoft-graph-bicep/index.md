...
| --- | --- | --- |
| Infrastructure | Rapid, reproducible PR environment spin-up & tear down | Long-lived shared dev environment |
...
* Storage Account (Standard\_LRS, StorageV2 kind) and Key Vault (RBAC permission model, soft delete enabled) deployed.
